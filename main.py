...
if __name__ == "__main__":
    ...
    # regularagent.train(render=False, total_steps=100_000)
    # regularagent.run("output/FlappyBird-v0_dqn.pt", episodes=3, max_steps=100_000)

    doubleagent = DoubleAgent(configuration_name)
    # doubleagent.train(render=False, total_steps=100_000)
    doubleagent.run("output/FlappyBird-v0_dqn.pt", episodes=3, max_steps=100_000)
