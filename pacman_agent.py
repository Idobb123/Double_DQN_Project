...
class PacManDQL():
    ...
    def train(self, episodes, is_slippery=False):
        ...
        env = gym.make('MsPacmanNoFrameskip-v4', render_mode=None)
        ...
        # Save policy
        torch.save(policy_dqn.state_dict(), "msPacMan_dqn.pt")
